...
#elif (DEMO_PANEL == DMB_DISPLAY)
#define DEMO_LCDIF_HSW 16
#define DEMO_LCDIF_HFP 38
#define DEMO_LCDIF_HBP 32
#define DEMO_LCDIF_VSW 4
#define DEMO_LCDIF_VFP 8
#define DEMO_LCDIF_VBP 4
...
static void BOARD_InitLcdifClock(void)
{
     ...
     * Here use the aux0 pll (396MHz) as clock source, pixel clock set to 36MHz, (uskh: what is it for us?)
     * then frame rate is:
     *
     * RK055IQH091: 60Hz
     * RK055AHD091: 35Hz
